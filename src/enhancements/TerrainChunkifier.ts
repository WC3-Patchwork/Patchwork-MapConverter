...
const TerrainChunkifier = {  chunkifyTerrain: async function(terrain: Terrain, doodads: Doodad[], specialDoodads: SpecialDoodad[], units: Unit[], regions: Region[], cameras: Camera[], chunkSize: MapSize): Promise<void> {
  ...
  tasks.push(writeData(terrainData,'/terrain/data.json'))
